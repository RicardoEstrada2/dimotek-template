...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/work">Soluciones</NavigationItem>
    ...
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      <header>
        ...
        <motion.div
          ...
          className="relative z-50 overflow-hidden background-dimotek pt-2"
          aria-hidden={expanded ? undefined : 'true'}
          // @ts-ignore (https://github.com/facebook/react/issues/17157)
          inert={expanded ? undefined : ''}
        >
          <motion.div layout className="background-dimotek">
            <div ref={navRef} className="background-dimotek pb-16 pt-14">
              <Header
                invert
                panelId={panelId}
                icon={XIcon}
            ...
            <Navigation />
            <div className="relative background-dimotek before:absolute before:inset-x-0 before:top-0 before:h-px before:background-dimotek">
              <Container>
